---
title: "<span style ='font-size:40px; font-weight:bold;'>Práctica 13.Comparación de medias (II)</span>" 
...
En primer lugar, vamos a preparar una base de datos de nuestro directorio de trabajo, df_iam4_r, que puedes obtener de la Carpeta de la Práctica 13 en el Aula Virtual:
...
```{r}
#install.packages("pairwiseCI")  # Solo hay que hacerlo una vez
library(pairwiseCI)
...
# p-value con ajuste de Bonferroni
pw1 <- pairwiseTest(colesterol ~ clas_soc, data = df_iam4,)
...
Parece no haber hrandes diferencias. Vamos a estudiarlo con un test. Primero estudiamos la normalidad e igualdad de varianzas
