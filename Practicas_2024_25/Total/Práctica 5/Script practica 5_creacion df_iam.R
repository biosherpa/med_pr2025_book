...
df_iam <- data.frame(fech_nac,sex, alt, peso, hta,fum, colesterol, clas_soc, iam)
...
write.csv(df_iam, file = "C:/Users/jesus.martin/OneDrive - Madrid Digital/Docente/Introducción a la AP/Curso 2024_25/Bioestadística 1/Prácticas/Práctica 5/df_iam.csv", row.names = FALSE)