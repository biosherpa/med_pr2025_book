...
# Cremoa clas_soc con diferente probabilidad de distirbución de diferentes factores de riesgo
...
write.csv(df_iam3, file = "C:/Users/jesus.martin/OneDrive - Madrid Digital/Docente/Introducción a la AP/Curso 2024_25/Bioestadística 1/Prácticas/Práctica 9/df_iam3.csv", row.names = FALSE)
...
df_iam3$clas_soc <- factor(df_iam3$clas_soc, levels = c(0, 1), labels = c("Baja", "Alta"))
...
write.csv(df_iam3_r, file = "C:/Users/jesus.martin/OneDrive - Madrid Digital/Docente/Introducción a la AP/Curso 2024_25/Bioestadística 1/Prácticas/Práctica 9/df_iam3_r.csv", row.names = FALSE)
